...
<body
	...
	<div class="loginDiv" id="loginDiv">
		<form action="loginServlet" method="post" id="form">
			...
			<p>
				负责人账号:<input id="username" name="username" type="text"
					value="${cookie.username.value}">
			</p>
			<p>
				负责人密码:<input id="password" name="password" type="password"
			...
			<p>
				<input type="hidden" id="loginType" name="loginType" value="role">
			</p>
			<div id="subDiv">
